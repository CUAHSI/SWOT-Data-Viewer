...
output_spatial_reference = arcpy.SpatialReference(3857)  # Example spatial reference, adjust as needed
...
for dataset in datasets:
    for fc in arcpy.ListFeatureClasses("*", "ALL", dataset):
        ...
        output_path = os.path.join(output_directory, output_gdb + ".gdb", output_fc_name)
